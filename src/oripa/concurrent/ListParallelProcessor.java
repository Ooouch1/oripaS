...
public class ListParallelProcessor<Value, Output> {

	PartialCollectionProcessFactory<Value, Output> processFactory;

	//private ArrayList<Collection<Value>> valueSets;



	public ListParallelProcessor(PartialCollectionProcessFactory<Value, Output> processFactory) {
	...
	public ArrayList<Output> execute(final List<Value> values, int divNum) 
		...
		ArrayList<Output> result = new ArrayList<>(values.size());
